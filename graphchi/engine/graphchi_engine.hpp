...
namespace graphchi {
    ...
    public:
         ...
         */
        graphchi_engine(std::string _base_filename, int _nshards, bool _selective_scheduling, metrics &_m, int walks_per_source, int steps_per_walk) : base_filename(_base_filename), nshards(_nshards), use_selective_scheduling(_selective_scheduling), m(_m), _walks_per_source(walks_per_source), _steps_per_walk(steps_per_walk) {
            /* Initialize IO */
